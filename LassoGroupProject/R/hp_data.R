#' House price dataset
#' 
#' A dataset containing information about the residential home market in
#' Ames, Iowa, United States in 2009.
#' 
#' @name hp_data
#' @docType data
#' @format A data frame with 338 rows and 255 variables:
#' \describe{
...
#' item{SalePrice}{Log of the original sale price}
...
#' }
#' @source \url{De Cock D. Ames, Iowa: 
#' Alternative to the Boston housing 
#' data as an end of semester 
#' regression project[J]. Journal of 
#' Statistics Education, 2011, 19(3).}
NULL